...
def create_question(question_text: str, day: int) -> Question:
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self) -> None:
        ...
        """
        question_1 = create_question(question_text="First past question.", day=-30)
        question_2 = create_question(question_text="Second past question.", day=-5)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(response.context["latest_questions_list"], [question_2, question_1])
